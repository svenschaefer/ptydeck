...
- `QLT-231` is now the next slice because the remaining promoted risk has shifted to frontend bootstrap/control seams after the backend auth and runtime/session lifecycle slices were closed.
