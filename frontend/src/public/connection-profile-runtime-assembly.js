import { createConnectionProfileRuntimeActions as defaultCreateConnectionProfileRuntimeActions } from "./connection-profile-runtime-actions.js";
import { buildBlankConnectionProfileLaunch as defaultBuildBlankConnectionProfileLaunch } from "./connection-profile-draft-state.js";
import { createConnectionProfileRuntimePresentation as defaultCreateConnectionProfileRuntimePresentation } from "./connection-profile-runtime-presentation.js";
import { createConnectionProfileSshLifecycle as defaultCreateConnectionProfileSshLifecycle } from "./connection-profile-ssh-lifecycle.js";
import { createConnectionProfileUiBindings as defaultCreateConnectionProfileUiBindings } from "./connection-profile-ui-bindings.js";
...
export function createConnectionProfileRuntimeAssembly(options = {}) {
  const createRuntimePresentation =
    typeof options.createRuntimePresentation === "function"
      ? options.createRuntimePresentation
      : defaultCreateConnectionProfileRuntimePresentation;
  const createSshLifecycle =
    typeof options.createSshLifecycle === "function" ? options.createSshLifecycle : defaultCreateConnectionProfileSshLifecycle;
  const createRuntimeActions =
    typeof options.createRuntimeActions === "function"
      ? options.createRuntimeActions
      : defaultCreateConnectionProfileRuntimeActions;
  const createUiBindings =
    typeof options.createUiBindings === "function" ? options.createUiBindings : defaultCreateConnectionProfileUiBindings;
  const buildBlankConnectionProfileLaunch =
    typeof options.buildBlankConnectionProfileLaunch === "function"
      ...
      : defaultBuildBlankConnectionProfileLaunch;
  ...
  const defaultThemeProfile = options.defaultThemeProfile;
  ...
  const sshLifecycle = createSshLifecycle({
    api,
    defaultDeckId,
    normalizeText,
    normalizeLower,
  ...
  const runtimeActions = createRuntimeActions({
    ...
    normalizeConnectionLaunch: options.normalizeConnectionLaunch,
  ...
  const { bindUiEvents } = createUiBindings({
    normalizeText,
    getErrorMessage,
    setError,
