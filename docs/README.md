...
- `Restart Streaming Analysis.md`
  ...
  - Current interpretation:
    ...
    - use the companion helper script `scripts/experiment-codex-sections.mjs` when testing the next structural step beyond `codex_separator_info`: chrome stripping plus separator-anchored section assembly that can preserve subsection labels and list items instead of requiring one single bullet entry
