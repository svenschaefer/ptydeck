...
function runtimeOperationKeys() {
  return new Set([
    ...
    "GET /connection-profiles/{profileId}",
    "PATCH /connection-profiles/{profileId}",
    "DELETE /connection-profiles/{profileId}",
    ...
    "POST /sessions/{sessionId}/control/take",
    "POST /sessions/{sessionId}/control/release",
    "POST /sessions/{sessionId}/control/transfer",
