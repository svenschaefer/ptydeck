...
- [x] `v0.4.0-H25` is now fully completed: `QLT-144`, `QLT-145`, `QLT-146`, `QLT-147`, `QLT-148`, and `QLT-149` are closed, and `TODO.md` currently has no active open implementation tasks.
