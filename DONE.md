...
- [x] Validation for this ARC-010 step passed: `npm --prefix frontend run lint`, `node --test frontend/test/session-settings-dialog-controller.test.js`, `node --test frontend/test/layout-settings-controller.test.js`, `node --test frontend/test/deck-sidebar-controller.test.js`, `node --test frontend/test/session-card-meta-controller.test.js`, and `node --test frontend/test/stream-builtins.test.js`.
