...
- [ ] `QLT-065` Owner: `FE` Task: Replace inline session settings panel with a proper per-terminal settings dialog (modal semantics, focus trap, Escape close, explicit save/cancel) opened via the terminal settings icon.
