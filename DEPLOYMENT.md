...
- Coding-agent planning chatter such as `next active block ...`, version bullets, `/review on my current changes` echoes, and low-value `Updated Plan`-style summaries should now stay suppressed instead of surfacing as Telegram status
