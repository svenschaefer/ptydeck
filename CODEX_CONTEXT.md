...
- `TODO.md`: active promoted tasks are `QLT-288` and `QLT-289`.
...
- frontend: `97.27%` line / `89.64%` branch
...
- `frontend/src/public/connection-profile-runtime-controller.js`: `1039` lines, `95.96%` line / `72.95%` branch
