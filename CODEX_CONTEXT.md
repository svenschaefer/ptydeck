...
- `TODO.md`: the active promoted tasks are `QLT-298`, `QLT-299`, `QLT-300`, and `QLT-301` inside `v0.4.0-H172`.
- `ROADMAP.md`: `v0.4.0-H172` is active with no queued next wave.
- `QLT-295`, `QLT-296`, and `QLT-297` are complete as the delivered slices inside `v0.4.0-H172`.
...
On 2026-05-05, the next quality-follow-up wave was promoted from the validated `H171` closeout tree and remains active after the first three delivered slices.
