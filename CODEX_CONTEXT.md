...
Last updated: 2026-03-24 (H15 completed; v0.4.0-H1 completed; ARC-009 completed in active v0.4.0-H2; ARC-010 UI/runtime controller extraction underway with terminal runtime, resize orchestration, runtime event routing, and grid render orchestration extracted; docs-vs-outlook alignment synced)
Owner: `CODY`
