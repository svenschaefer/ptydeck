...
- backend coverage: `96.80%` line / `90.19%` branch / `88.92%` funcs
...
- backend:
  - `backend/src/runtime.js`: `2788` lines, `84.54%` line / `76.96%` branch
...
Promoted on this review wave:

- `QLT-321` Owner `BE`: extract the next retained startup/ready/catalog authority seam from `backend/src/runtime.js`
