...
- `TODO.md`: the only active promoted task is `QLT-293`.
- `ROADMAP.md`: active wave `v0.4.0-H171` is promoted; no queued wave is currently promoted.
- `QLT-290`, `QLT-291`, `QLT-292`, and `QLT-294` are complete as the delivered slices inside `v0.4.0-H171`.
...
## Repo-Wide Quality Review Follow-Up (`v0.4.0-H171` active)
