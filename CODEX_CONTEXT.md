...
- backend coverage: `96.89%` line / `90.30%` branch / `88.91%` funcs
...
- backend:
  - `backend/src/runtime.js`: `2759` lines, `84.34%` line / `76.84%` branch
  - `backend/src/runtime-library-normalization.js`: `1724` lines, `87.12%` line / `82.73%` branch
  - `backend/src/session-manager.js`: `1043` lines, `94.53%` line / `73.91%` branch
  - `backend/src/runtime-startup-readiness.js`: `96.40%` line / `89.66%` branch
  ...
  - `backend/src/session-manager-replay-runtime.js`: `153` lines, `97.39%` line / `84.00%` branch
...
Current active tasks after the `H177` quality review:
