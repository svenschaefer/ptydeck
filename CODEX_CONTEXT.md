...
Last updated: 2026-03-23 (`QLT-090` completed: deck control slash surface and session move command baseline implemented in frontend)
Owner: `CODY`
...
- Active next cycles: `v0.3.0-H6` (remaining: `QLT-091` ... `QLT-093`).
  ...
  - Completed in cycle H (`v0.3.0-H6`): `QLT-083`, `QLT-084`, `QLT-085`, `QLT-086`, `QLT-087`, `QLT-088`, `QLT-089`, `QLT-090`.
  - Planned next in cycle H (`v0.3.0-H6`): `QLT-091`, `QLT-092`, `QLT-093`.
