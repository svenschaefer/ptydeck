...
- Active next cycles: none (enterprise readiness backlog in `TODO.md` is complete for current scope; deferred auth/tenant items remain in `OUTLOOK-TODO.md`).
