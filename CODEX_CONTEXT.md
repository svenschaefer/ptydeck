...
- Active next cycles: `v0.3.0-H5` (remaining: `QLT-082`, `PLAT-011`) and `v0.3.0-H6` (deck isolation + deck control plane).
  ...
  - Completed in cycle G: `QLT-080`, `QLT-081`.
  - Planned next in cycle G (`v0.3.0-H5`): `QLT-082`, `PLAT-011`.
