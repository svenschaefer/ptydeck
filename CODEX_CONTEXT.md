...
- backend coverage: `96.80%` line / `90.17%` branch / `88.86%` funcs
- frontend coverage: `97.52%` line / `90.54%` branch / `82.44%` funcs
...
- backend:
  - `backend/src/runtime.js`: `2788` lines, `84.34%` line / `76.80%` branch
  - `backend/src/runtime-library-normalization.js`: `1724` lines, `85.67%` line / `80.12%` branch
  ...
  - `backend/src/runtime-session-control-authority.js`: `445` lines, `95.06%` line / `90.48%` branch
...
Current active tasks after the first `H176` closeout:
