...
- Frontend command send path now normalizes to exactly one final CRLF (`\r\n`) terminator across direct input, routed input, and custom-command execution.
