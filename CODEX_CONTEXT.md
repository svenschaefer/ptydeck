...
Fresh repo-wide evidence on the current tree after the delivered backend `H177` block:

- root tooling coverage: `92.84%` line / `77.05%` branch / `94.83%` funcs
- backend coverage: `97.01%` line / `90.55%` branch / `88.71%` funcs
- frontend coverage: `97.54%` line / `90.62%` branch / `82.34%` funcs
...
- frontend:
  - `frontend/src/public/app-runtime-composition-controller.js`: `1361` lines, still the largest retained frontend runtime-composition monolith
  - `frontend/src/public/workspace-preset-runtime-state.js`: `980` lines, `95.51%` line / `82.96%` branch
  - `frontend/src/public/ui/session-terminal-runtime-controller.js`: `824` lines, `92.60%` line / `85.62%` branch
  - `frontend/src/public/connection-profile-draft-state.js`: `680` lines, `97.35%` line / `81.41%` branch
  - `frontend/src/public/split-layout-runtime-controller.js`: `660` lines, `95.45%` line / `77.68%` branch
  - `frontend/src/public/layout-profile-runtime-controller.js`: `520` lines, `93.27%` line / `86.55%` branch
  - `frontend/src/public/layout-runtime-state.js`: `260` lines, `91.92%` line / `81.72%` branch
  - `frontend/src/public/ws-runtime-controller.js`: `461` lines, `90.51%` line / `85.94%` branch

Current active tasks after the delivered backend `H177` slices:
