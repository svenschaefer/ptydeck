...
- The active near-term block remains `v0.3.0-H13`, now focused on the remaining built-in plugin and artifact layers (`ARC-006` ... `ARC-008`) on top of the completed stream-adapter, plugin-registry, and action-dispatch foundations.
...
- Active next cycles: `v0.3.0-H13`.
  ...
  - Completed in cycle O so far (`v0.3.0-H13`): `ARC-003`, `ARC-004`, `ARC-005`.
  - Planned next in cycle O (`v0.3.0-H13`): `ARC-006`, `ARC-007`, `ARC-008`.
