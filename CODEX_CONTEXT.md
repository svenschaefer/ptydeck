...
Last updated: 2026-03-22 (custom-command persistence/CRUD + guardrails + `/custom` define parser completed in `QLT-037` ... `QLT-039`; command extensibility backlog re-based to `QLT-040` ... `QLT-057`)
Owner: `CODY`
