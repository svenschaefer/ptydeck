...
- `TODO.md`: active promoted tasks are `QLT-285` through `QLT-289`.
...
- root tooling: `92.82%` line / `77.09%` branch
- backend: `95.47%` line / `89.43%` branch
- frontend: `97.23%` line / `89.59%` branch

Relevant hotspots promoted into `TODO.md` / `ROADMAP.md`:

- `backend/src/runtime.js`: `5834` lines, `78.61%` line / `68.87%` branch
- `backend/src/session-manager.js`: `1994` lines, `95.54%` line / `79.23%` branch
