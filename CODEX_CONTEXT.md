...
- Active next cycles: `v0.3.0-H3` tag-based multi-target control plus settings-via-slash parity (`QLT-072` ... `QLT-077`).
  ...
  - Completed in cycle E: `QLT-072`, `QLT-073`.
  - Planned next in cycle E (`v0.3.0-H3`): `QLT-074`, `QLT-075`, `QLT-076`, `QLT-077`.
