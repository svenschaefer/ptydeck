...
Fresh repo-wide evidence on the current tree after the delivered `H179` backend slices (`QLT-339`, `QLT-341`) and the remaining active `H179` backlog:

- root tooling coverage: `92.84%` line / `77.05%` branch / `94.83%` funcs
- backend coverage: `97.27%` line / `90.55%` branch / `88.08%` funcs
...
- backend:
  ...
  - `backend/src/runtime-library-normalization.js`: `1724` lines, `89.10%` line / `84.86%` branch
  - `backend/src/session-manager.js`: `720` lines, `94.31%` line / `81.95%` branch
  - `backend/src/runtime-session-resource-authority.js`: `372` lines, `88.98%` line / `81.25%` branch
...
Current active tasks after the delivered backend slices in `H179`:
