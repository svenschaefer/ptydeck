...
- `TODO.md`: active promoted tasks are `QLT-287` through `QLT-289`.
...
- root tooling: `92.82%` line / `77.09%` branch
- backend: `95.58%` line / `89.36%` branch
- frontend: `97.23%` line / `89.58%` branch
