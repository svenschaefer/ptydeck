...
Last updated: 2026-03-23 (`QLT-092` completed: multi-selector dedupe with deck selectors implemented in frontend)
Owner: `CODY`
...
- Active next cycles: `v0.3.0-H6` (remaining: `QLT-093`).
  ...
  - Completed in cycle H (`v0.3.0-H6`): `QLT-083`, `QLT-084`, `QLT-085`, `QLT-086`, `QLT-087`, `QLT-088`, `QLT-089`, `QLT-090`, `QLT-091`, `QLT-092`.
  - Planned next in cycle H (`v0.3.0-H6`): `QLT-093`.
