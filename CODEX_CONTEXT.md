...
Last updated: 2026-03-24 (H7 xterm compatibility adapter sync completed)
Owner: `CODY`
...
- Active next cycles: `v0.3.0-H7` frontend state correctness and architecture consolidation.
  ...
  - Completed in cycle I (`v0.3.0-H7`): `QLT-095`, `QLT-096`, `QLT-097`, `QLT-098`, `QLT-099`, `QLT-101`, `QLT-104`, `QLT-105`, `QLT-106`, `QLT-107`, `QLT-108`, `QLT-109`.
  - Planned next in cycle I (`v0.3.0-H7`): `QLT-100`, `QLT-102`, `QLT-103`.
