...
Fresh repo-wide evidence on the current tree after the `H179` closeout and the delivered `H180` backend slices `QLT-345` through `QLT-347`:

- root tooling coverage: `92.84%` line / `77.05%` branch / `94.83%` funcs
- backend coverage: `97.43%` line / `90.84%` branch / `88.14%` funcs
- frontend coverage: `97.67%` line / `90.89%` branch / `82.46%` funcs
...
- backend:
  - `backend/src/runtime.js`: `2037` lines, `87.73%` line / `81.64%` branch, still the largest retained backend authority surface
  - `backend/src/runtime-library-normalization.js`: `1724` lines, `90.95%` line / `86.35%` branch
  - `backend/src/session-manager.js`: `644` lines, `94.25%` line / `88.00%` branch
  - `backend/src/runtime-session-resource-authority.js`: `372` lines, `95.43%` line / `89.08%` branch
  ...
  - `backend/src/runtime-lifecycle.js`: `100.00%` line / `100.00%` branch
  - `backend/src/runtime-library-normalization.js`: `1724` lines, `91.94%` line / `86.92%` branch
  - `backend/src/session-manager-trace-runtime.js`: `100.00%` line / `94.29%` branch
- frontend:
  - `frontend/src/public/app-runtime-composition-controller.js`: `1280` lines, still the largest retained frontend runtime-composition monolith after the latest helper extractions
  - `frontend/src/public/split-layout-runtime-controller.js`: `545` lines, `95.60%` line / `81.71%` branch
  - `frontend/src/public/layout-profile-runtime-controller.js`: `499` lines, `93.39%` line / `86.34%` branch
  - `frontend/src/public/connection-profile-draft-state.js`: `680` lines, `99.71%` line / `88.94%` branch
  - `frontend/src/public/ui/session-terminal-runtime-controller.js`: `824` lines, `93.45%` line / `87.34%` branch
  - `frontend/src/public/layout-split-layout-runtime-state.js`: `216` lines, `96.30%` line / `79.57%` branch
  - `frontend/src/public/layout-runtime-state.js`: `260` lines, `97.31%` line / `90.43%` branch
  - `frontend/src/public/layout-workspace-runtime-state.js`: `141` lines, `98.58%` line / `74.60%` branch

Current active tasks in `H180`:
