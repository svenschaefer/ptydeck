...
- `TODO.md` currently contains open tasks only (`ARC-010A` ... `ARC-010D`, `ARC-011`, `ARC-012`, `QLT-123`, `QLT-124`); completed history remains exclusively in `DONE.md`.
