...
- `QLT-290`, `QLT-291`, `QLT-292`, `QLT-293`, and `QLT-294` are complete as the delivered slices inside `v0.4.0-H171`.
...
The latest validation on 2026-05-05 after the `QLT-293` and `v0.4.0-H171` closeout reran `npm --prefix backend run test:coverage`, `npm run docs:check`, `npm run lint`, `npm run test`, `npm run test:coverage:check`, and `git diff --check`. The validated coverage totals are root tooling `92.82%` line / `77.09%` branch, backend `95.68%` line / `89.29%` branch, and frontend `97.38%` line / `89.90%` branch.
