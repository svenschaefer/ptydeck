...
Fresh repo-wide evidence on the validated `H181` closeout tree:

- root tooling coverage: `92.84%` line / `77.05%` branch / `94.83%` funcs
- backend coverage: `97.47%` line / `91.00%` branch / `87.65%` funcs
