...
- Planning baseline now includes command-submit semantics hardening tasks (`QLT-069`, `QLT-070`) to close remaining shell vs TUI submit behavior gaps.
...
- Active next cycles: `v0.3.0-H1C` command extensibility/UX hardening, `v0.3.0-H1D` per-terminal settings/theme personalization, and `v0.3.0-H2` enterprise readiness backlog (current-scope subset in `TODO.md`; deferred auth/tenant items in `OUTLOOK-TODO.md`).
  ...
  - Planned next in cycle C (`v0.3.0-H1C`): remaining custom slash-command and command-UX tasks from `TODO.md` (`QLT-046`, `QLT-051`, `QLT-055`, `QLT-057`, `QLT-069`, `QLT-070`).
