...
Last updated: 2026-03-23 (`QLT-091` completed: active-deck selector isolation and explicit cross-deck selector routing implemented in frontend)
Owner: `CODY`
...
- Active next cycles: `v0.3.0-H6` (remaining: `QLT-092` ... `QLT-093`).
  ...
  - Completed in cycle H (`v0.3.0-H6`): `QLT-083`, `QLT-084`, `QLT-085`, `QLT-086`, `QLT-087`, `QLT-088`, `QLT-089`, `QLT-090`, `QLT-091`.
  - Planned next in cycle H (`v0.3.0-H6`): `QLT-092`, `QLT-093`.
